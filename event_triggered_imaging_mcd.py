...
class EventTriggeredImagingMCD(QtGui.QWidget):
    def __init__(self, parent):
        ...
        self.parent.root_dir = '/media/cat/8TB/in_vivo/tim/dongsheng/'
        self.parent.n_sec = 3
    ...
    def slct_recording_event(self):
        self.selected_recording = QtGui.QFileDialog.getOpenFileName(self, "*.npy", self.selected_recording,"(*.npy)")
    ...
    def slct_event_file(self):
        self.selected_sort =  QtGui.QFileDialog.getOpenFileName(self, ".ptcs, .txt)", self.selected_recording,"*.ptcs *.txt")
